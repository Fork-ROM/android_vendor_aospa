...
rm -rf * .*
repo init --depth=1 --no-repo-verify -u https://github.com/AOSPA/manifest.git -b topaz -g default,-mips,-darwin,-notdefault > k
git clone https://github.com/XenStuff/manifest.git --depth 1 -b aospa .repo/local_manifests > m
repo sync -c --no-clone-bundle --no-tags --optimized-fetch --prune --force-sync -j8 > k
